package com.example.projectprak.model
...
class AuthViewModel : ViewModel() {
    ...
    private val database: FirebaseDatabase = FirebaseDatabase.getInstance("https://projectpraktodolist-default-rtdb.firebaseio.com/")
